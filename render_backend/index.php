...
<div class="product-card"><span class="badge-discount">-10%</span><div class="img-wrap"><img src="images/img-1.jpg" alt="Rose Elegance"></div><div class="card-body"><h3>Satin Flower Pot - Rose Elegance</h3><p class="card-desc">Elegant rose arrangement perfect for home decor</p><div class="card-footer"><span class="price">₱1 <span class="old">₱50</span></span><button class="btn-order" onclick="openPreOrder('Satin Flower Pot - Rose Elegance',1)">Order Now</button></div></div></div>
<div class="product-card"><span class="badge-discount">-15%</span><div class="img-wrap"><img src="images/img-2.jpg" alt="Davao Delight"></div><div class="card-body"><h3>Satin Flower Pot - Davao Delight</h3><p class="card-desc">Vibrant Davao-inspired floral centerpiece</p><div class="card-footer"><span class="price">₱1 <span class="old">₱10</span></span><button class="btn-order" onclick="openPreOrder('Satin Flower Pot - Davao Delight',1)">Order Now</button></div></div></div>
<div class="product-card"><span class="badge-discount">-8%</span><div class="img-wrap"><img src="images/img-3.jpg" alt="Blush Bouquet"></div><div class="card-body"><h3>Satin Flower Pot - Blush Bouquet</h3><p class="card-desc">Soft blush arrangement for special occasions</p><div class="card-footer"><span class="price">₱1 <span class="old">₱100</span></span><button class="btn-order" onclick="openPreOrder('Satin Flower Pot - Blush Bouquet',1)">Order Now</button></div></div></div>
<div class="product-card"><span class="badge-discount">-12%</span><div class="img-wrap"><img src="images/img-4.jpg" alt="Sunburst"></div><div class="card-body"><h3>Satin Flower Pot - Sunburst</h3><p class="card-desc">Bright and cheerful sunburst design</p><div class="card-footer"><span class="price">₱1 <span class="old">₱10</span></span><button class="btn-order" onclick="openPreOrder('Satin Flower Pot - Sunburst',1)">Order Now</button></div></div></div>
<div class="product-card"><span class="badge-discount">-10%</span><div class="img-wrap"><img src="images/image-5.png" alt="Lavender Dream"></div><div class="card-body"><h3>Satin Flower Pot - Lavender Dream</h3><p class="card-desc">Premium lavender-themed floral arrangement</p><div class="card-footer"><span class="price">₱1,200 <span class="old">₱1,340</span></span><button class="btn-order" onclick="openPreOrder('Satin Flower Pot - Lavender Dream',1200)">Order Now</button></div></div></div>
</div>
</section>
