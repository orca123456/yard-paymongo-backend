...
<head>
    ...
    <title>Payment Failed - Yard Handicraft</title>
    ...
    <style>
        ...
        *{
        ...
        body{
            ...
            background:linear-gradient(135deg, #fff5f5, #f8f9fb);
            padding:2rem;
        }
...
<body>
    <div class="card">
        ...
        <p>Your payment was not completed or was cancelled.</p>
        <p>Please try again to continue your order.</p>
